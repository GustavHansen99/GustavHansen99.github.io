...
One can see in Figure 1 that assault crimes are most popular during the evenings when the bars are much higher compared to the mornings. This means that you must be cautious regarding assault crimes. You should be quick to get home from work since assault crimes tend to happen during the evenings. The assault crime, which occurred on the 28th of February 2023, happened at around 17:40, which is also during the evening. According to Figure 1, this is also where the assault crimes peak in counts. Another fascinating peak we show in the figure is the peak at 12:00 - around lunch. You should also be cautious during this time.

Knowing when assaults take place only offers half the story. How about where? In Figure 2, we present a map of San Francisco where one can see the exact position of each assault crime taking place in the month of February between 2003-2017. In this way, we showcase the tendency of assaults in February as the 2023 incident also took place during this month. Even though the figure only shows a sample of the data, we can confirm that the sample is representative for the true distribution of every month.
